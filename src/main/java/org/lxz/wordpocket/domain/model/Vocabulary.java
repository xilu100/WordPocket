...
public class Vocabulary {
  ...
  @PersistenceCreator
  public Vocabulary(Long id, String word, Property properties, History history, String location,
      Picture picture) {
    this.id = id;
    this.word = word;
  ...
  public static Vocabulary create(String word, Property properties, String location,
      Picture picture) {
